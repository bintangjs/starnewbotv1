...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EpMDOG6IiII6sKF7n8N4.IKSUnw5dTbfne95QEJYXPa.zxJ7FJhjxShTpTsTnE9lFZCNkQb0A2rAUBoiuEC8TBA=')
kr.loginResult()
...
#======================== FOR COMMAND MODE ON STARTING ==========================#
                ...
                if wait["cancelprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи ѕєт ��σ σи")
                    else:
                        kr.sendText(msg.to,"¢αи¢єℓ ρяσтє¢тισи αℓяєα∂у σи")
...
#==============================================================================#
            ...
            elif msg.text in ["sisitipi","sider"]:
                 if msg.toType == 2:
                    print "\nRead aktif..."
                    if msg.to in wait2['readPoint']:
                        ...
                        kr.sendText(msg.to, "Ketik [Cctv on] dulu, baru ketik [sider]")
    ...
    for zx in range(0,10):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          kr.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By��􀸂􀅞└Babang-Adhi✗┐�􀸂􀅠∆� http://line.me/ti/p/~jkp4678")
          print "Like"
        except:
          pass
      else:
